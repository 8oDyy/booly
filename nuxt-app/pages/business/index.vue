      ...
      <div class="absolute top-4 left-4 right-4 flex justify-between items-start">
        ...
        <div class="flex gap-2">
          ...
          >
            <HeartIcon
              class="w-5 h-5"
              :class="isFavorite ? 'text-red-500 fill-red-500' : 'text-gray-700'"
            />
          </button>
          <button
            @click="sharePlace"
              ...
              <div class="flex items-center gap-2">
                <div class="flex items-center">
                  <StarIcon
                    ...
                    :key="i"
                    class="w-5 h-5"
                    :class="i <= Math.floor(business.rating) ? 'text-yellow-400 fill-yellow-400' : 'text-gray-300'"
                  />
                </div>
                <span class="text-xl font-semibold text-gray-900">{{ business.rating.toFixed(1) }}</span>
                <span class="text-gray-600">({{ business.reviewCount }} avis)</span>
              </div>
              
              <div class="flex items-center gap-2">
                <span class="text-sm text-gray-600">Gamme de prix:</span>
                <span class="text-sm font-medium">{{ business.priceRange }}</span>
              </div>
            </div>
